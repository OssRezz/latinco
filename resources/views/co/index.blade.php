    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-7 mb-3">
            <div class="card shadow-sm">
                <div class="card-header text-rosado"><i class="fas fa-list text-rosado"></i> <b>Lista de centro de operaciones</b></div>
                <div class="card-body">
                    @if ($cos->isEmpty())
                                ...
                                @foreach ($cos as $co)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a class="btn btn-outline-danger btn-table border-0 btn-sm" href="{{ route('admin.co.show', $co->id) }}">
                                                <i class="fas fa-eye" style="pointer-events: none"></i>
                                            </a>
                                            <a class="btn btn-outline-danger btn-table border-0 btn-sm" href="{{ route('admin.co.edit', $co->id) }}">
